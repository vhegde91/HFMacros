// Mainframe macro generated from application: /home/vinay/root-6.04.02/bin/root.exe
// By ROOT version 6.04/02 on 2015-10-27 15:19:07
...
void Style_Modern1()
{
   ...
   tmpStyle->SetStatW(0.34);
   tmpStyle->SetStatH(0.45);
