...
void c_RatiovsIeta::FileNames(){
  FileList = new TList();
  //  FileList->Add( TFile::Open("2015D_E2E1HistsTrgAll.root") );
  //  FileList->Add( TFile::Open("254833_E2E1HistsTrg1.root") );
  //FileList->Add( TFile::Open("MC_E2E1HistsTrg1.root") );MCfileIndex=1;
 
  //FileList->Add( TFile::Open("MC25ns_E2E1HistsTrg5.root") );MCfileIndex=1;
  FileList->Add( TFile::Open("254833NewTRG_E2E1HistsTrg5.root") );
  FileList->Add( TFile::Open("MC_NewTRG_E2E1HistsTrg5.root") );MCfileIndex=1;
  //  FileList->Add( TFile::Open("254833_E2E1HistsTrg1.root") );
  //  FileList->Add( TFile::Open("MC_E2E1HistsTrg1.root") );MCfileIndex=1;
...
void c_RatiovsIeta::RatiovsIeta1(int cutnum){
  ...
  h_mRatiovsIeta[0]->GetYaxis()->SetTitle("<Ratio>");
  h_mRatiovsIeta[0]->GetXaxis()->SetTitle("ieta");
