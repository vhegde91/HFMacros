...
int nietaHF=26;
const int nfiles=3;    //Specify no. of files
TFile *f[nfiles];
...
void Ratio1DPlotsComapreRuns(const char* iDirName){
  TDirectory *dir[nfiles];
  TCanvas *c_ieta[4];
  //================Files to be Compared=========================
  /* f[0]=TFile::Open("MC_E2E1HistsTrg1.root");
  f[1]=TFile::Open("254833_E2E1HistsTrg1.root");
  f[2]=TFile::Open("MC_E2E1HistsTrg_170to300.root");
  */
  f[0]=TFile::Open("2012D_E2E1HistsVtx.root");
  f[1]=TFile::Open("2015B_E2E1HistsVtx.root");
